...
Use Mann-Whitney test to compare total subway entries by UNIT and date on 
...
daily_entries = (turnstile_weather[['DATEn','UNIT','ENTRIESn_hourly']].
...
U, p = scipy.stats.mannwhitneyu(no_rain['ENTRIESn_hourly'], 
