...
Run Welch's t-test for difference between rain/no-rain entries using improved dataset
"""
import numpy as np
import pandas
import scipy.stats
...
# alt: mean ENTRIESn_hourly with rain does not equal mean ENTRIESn_hourly with no rain
# two-tailed test, p-crit = .05
t, p = scipy.stats.ttest_ind(rain_hourly['ENTRIESn_hourly'], no_rain_hourly['ENTRIESn_hourly'], equal_var=False)
