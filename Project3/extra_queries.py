...
q5 = 'Number of nodes within 5km of Palmyra timestamped since May 13, 2015: ' 
# the date ISIS took over Palmyra
...
q5_pipeline = [{"$geoNear" : {"spherical" : "true" , 
                               "near" : {"type" : "Point" , 
                                "coordinates" : [38.2809746, 34.5560155]}, 
                                "distanceField" : "dist.calculated", 
                                "maxDistance" : 5000, "limit" : 10000 }},
...
query5_result = []
# when accessing the geospatial index find() must be called on the 
# collection key on which the geospatial index was built, in this case 
# "geometry" find() returns a cursor over the set of results
for doc in db.osm_syria.find({"geometry" : { "$near" : { "$geometry" : 
                            { "type" : "Point", 
                            "coordinates" : [38.2809746, 34.5560155]}, 
                            "$maxDistance" : 5000 }}}):
