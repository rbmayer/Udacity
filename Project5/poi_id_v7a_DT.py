...
Using modified email indicators, non-scaled features and decision tree
...
parameters = {'min_samples_split':[2, 10, 50, 100], 'criterion':('gini', 'entropy')}
clf_GridSearch = grid_search.GridSearchCV(tr, parameters, scoring='f1')
